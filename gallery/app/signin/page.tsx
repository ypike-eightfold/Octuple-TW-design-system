...
export default async function SignInPage({ searchParams }: Props) {
  ...
  if (process.env.NEXT_PUBLIC_AUTH_BYPASS === "true") {
    return (
      <div className="mx-auto mt-20 max-w-md rounded-lg border border-[var(--color-border)] bg-[var(--color-card)] p-8">
  ...
  return (
    <div className="mx-auto mt-20 max-w-md rounded-lg border border-[var(--color-border)] bg-[var(--color-card)] p-8">
      ...
      >
        <button
          type="submit"
          className="w-full rounded-md bg-[var(--color-accent)] px-4 py-2.5 text-sm font-medium text-white transition hover:opacity-90"
        >
